...
systemDictionary = {
	...
	"Channel management": {
	  ...
	  "An adapter instance can receive messages. These messages consist of an object with several attributes that can be included as parameters in a message template. These parameters are replaced accordingly before the message is sent. <br> Details on the usage can be found in the Help section - Chapter 2.2.3 Message templates.": {
		...
		"pt": "Uma instância do adaptador pode receber mensagens. Estas mensagens consistem em um objeto com vários atributos que podem ser incluídos como parâmetros em um modelo de mensagem. Estes parâmetros são substituídos de acordo antes que a mensagem seja enviada. <br> Detalhes sobre o uso podem ser encontrados na seção Ajuda - Capítulo 2.2.3 Modelos de mensagem.",
		"nl": "Een adapter kan berichten ontvangen. Deze berichten bevatten een object met verschillende attributen die kunnen worden gebruikt als parameters in een boodschap tempet. Deze parameters zijn volgens de boodschap vervangen. Quality over Quantity (QoQ) Releases Vertaling:.",
		"fr": "Une instance d'adaptation peut recevoir des messages. Ces messages se composent d'un objet avec plusieurs attributs qui peuvent être inclus comme paramètres dans un modèle de message. Ces paramètres sont remplacés en conséquence avant l'envoi du message. Les détails sur l'utilisation se trouvent dans la section Aide - Chapitre 2.2.3 Modèles de messages.",
		"it": "Un'istanza adattatore può ricevere messaggi. Questi messaggi sono costituiti da un oggetto con diversi attributi che possono essere inclusi come parametri in un modello di messaggio. Questi parametri vengono sostituiti di conseguenza prima dell'invio del messaggio. <br> Dettagli sull'uso possono essere trovati nella sezione Aiuto - Capitolo 2.2.3 Modelli di messaggi.",
		"es": "Una instancia de adaptador puede recibir mensajes. Estos mensajes consisten en un objeto con varios atributos que se pueden incluir como parámetros en una plantilla de mensaje. Estos parámetros se reemplazan en consecuencia antes de enviar el mensaje. Los detalles sobre el uso se pueden encontrar en la sección Ayuda - Capítulo 2.2.3 Plantillas de mensaje.",
